...
const mockParts = [
  { id: 'PT001', name: 'Lọc dầu động cơ', price: 350000 },
  { id: 'PT002', name: 'Bugi đánh lửa', price: 120000 },
  { id: 'PT003', name: 'Dây curoa tổng', price: 800000 },
  { id: 'PT004', name: 'Bộ lọc gió động cơ', price: 250000 },
  { id: 'PT005', name: 'Bộ phanh trước', price: 1200000 },
];
...
const mockImportOrders = [
  {
    ...
    status: 'Hoàn thành',
    items: [
      { partId: 'PT001', partName: 'Lọc dầu động cơ', quantity: 10, price: 350000, total: 3500000 },
      { partId: 'PT002', partName: 'Bugi đánh lửa', quantity: 20, price: 120000, total: 2400000 },
    ],
  ...
  },
  {
    ...
    status: 'Đang xử lý',
    items: [
      { partId: 'PT003', partName: 'Dây curoa tổng', quantity: 5, price: 800000, total: 4000000 },
    ],
...
export default function ImportPage() {
  ...
  const filteredOrders = mockImportOrders.filter(order => {
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex justify-between items-center px-8 py-6 border-b bg-white shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Nhập Kho Phụ Tùng</h1>
              <p className="text-sm text-gray-600">Quản lý phiếu nhập kho và tra cứu lịch sử</p>
            </div>
          </div>
          <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-gray-900">Tạo Phiếu Nhập Mới</h2>
                <button
