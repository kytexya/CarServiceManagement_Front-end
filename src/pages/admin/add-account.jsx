...
export default function AdminAddAccountPage() {
    ...
    const onSubmit = (data) => {
        ...
        showError("Chức năng thêm tài khoản chưa được kết nối API.");
    };
        ...
        <div className="flex flex-row w-full h-screen bg-gray-50">
            ...
            <div className="flex flex-col w-full">
                <div className="flex justify-between items-center px-8 py-4 border-b bg-white">
                    <h1 className="text-2xl font-bold">Tạo Tài Khoản Hệ Thống Mới</h1>
                    ...
                    <form className="bg-white rounded-xl border p-8 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`input-field mt-2 ${errors.username ? "border-red-500" : "border-gray-300"}`}
                                {...register("username", {
                                    required: "Vui lòng nhập tên đăng nhập",
                                    minLength: { value: 5, message: "Tên đăng nhập phải có ít nhất 5 ký tự" },
                                })}
                            />
