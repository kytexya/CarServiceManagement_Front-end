  ...
  const serviceOrders = [
    {
      ...
      phone: '0123456789',
      report: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to ma',
      status: 'pending',
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Danh sách báo cáo lỗi / tạm ngưng xử lý</h1>
        <a href='/service-staff/problem-reporting/new' className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2 font-semibold shadow transition-colors duration-200 flex items-center">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredOrders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-50">
                  ...
                  <td className='px-6 py-4'>
                    <p className='text-sm max-w-[400px] line-clamp-2 text-ellipsis'>
                      {order.report}
                    </p>
                  </td>
                  <td className="px-6 py-4">
